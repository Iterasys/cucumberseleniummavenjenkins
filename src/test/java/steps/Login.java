...
public class Login {
	...
	@Given("^que o Usuario acessa o site TestLink$")
	public void que_o_Usuario_acessa_o_site_TestLink() throws Throwable {
	...
	public void exibe_a_pagina_principal_com_o_usuario_e_perfil_logado() throws Throwable {
		System.out.println("Passo 3 - Validar Usuário e Perfil");
